...
latten1 = torch.load("/home/wg25r/make_it_move/TransPixar-full/Mochi/video_alpha/cuttlefish_4_002.latent.pt")["ldist"].float()
...
vae.enable_slicing()
vae.enable_tiling()
data = latten * std / vae.config.scaling_factor + mean
with torch.no_grad():
